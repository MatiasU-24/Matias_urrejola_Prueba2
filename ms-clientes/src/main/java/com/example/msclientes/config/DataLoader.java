    ...
    CommandLineRunner cargarDatos(ClienteRepository clienteRepository, DireccionRepository direccionRepository) {
        return args -> {
            if (clienteRepository.count() == 0) {
                Cliente c1 = clienteRepository.save(new Cliente(null, "Ana", "Lopez", "ana.lopez@mail.com", "912345678", 120, true, LocalDate.now().minusMonths(8), "Chilena"));
                Cliente c2 = clienteRepository.save(new Cliente(null, "Pedro", "Rojas", "pedro.rojas@mail.com", "923456789", 60, true, LocalDate.now().minusMonths(5), "Chilena"));
                Cliente c3 = clienteRepository.save(new Cliente(null, "Camila", "Soto", "camila.soto@mail.com", "934567890", 200, true, LocalDate.now().minusMonths(2), "Chilena"));
